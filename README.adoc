...
=== Bolt Read only connection

You can specify a fixed read only connection in this way
`jdbc:neo4j:bolt://<host>:<port>/?readOnly=true`

Please consider that any further modification via the `Connection#setReadOnly` method will have no effect
